...
class Barang extends CI_Controller {
    ...
    public function index($page = 1)
    {
        ...
        $jumlah_data = $this->Db_model->recordbarang_count();
        
        $limit = 3;
        
        $data['page'] = $page;
        $data['jumlah_page'] = $jumlah_data / $limit;
        $data['records'] = $this->Db_model->get_data_barang($limit,$page);
    ...
    function search_data_barang()
    {
        ...
        if($this->form_validation->run() != FALSE )
        {
            ...
            //$this->session->set_userdata('nodata', FALSE);
            redirect("Barang");
        }
        else
        {
    ...
    function do_add_new()
    {
        ...
        $this->Db_model->add_data_barang($data);
    ...
    function do_edit($id)
    {
        ...
        $this->form_validation->set_rules('satuan_barang','Satuan barang','required|alpha');
